    ...
    */
    ...
    for (var i = 0; i < 5 * multiplier; i++) {
        if (i < 4 * multiplier) {
            ...
            //Coringa
            this.drawPile.push(new Card(this.generateRandomID(), 'Álcool gel (70%)', $.CARD.REGULAR, 18, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer adversário a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'Lenços umidecidos', $.CARD.REGULAR, 17, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer adversário a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'Máscara', $.CARD.REGULAR, 19, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer adversário a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'Lenços de papel', $.CARD.REGULAR, 20, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer adversário a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'Água limpa e sabão', $.CARD.REGULAR, 21, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer adversário a sua escolha.'));
        }
