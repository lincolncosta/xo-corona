    ...
    */
    ...
    for (var i = 0; i < 5 * multiplier; i++) {
        if (i < 4 * multiplier) {
            ...
            //Coringa
            this.drawPile.push(new Card(this.generateRandomID(), 'alcool', $.CARD.REGULAR, 4, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer jogador a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'lenços-umidecidos', $.CARD.REGULAR, 5, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer jogador a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'mascara', $.CARD.REGULAR, 6, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer jogador a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'lenços-papel', $.CARD.REGULAR, 7, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer jogador a sua escolha.'));
            this.drawPile.push(new Card(this.generateRandomID(), 'agua', $.CARD.REGULAR, 8, 'É uma carta coringa, mas apesar do nome, não têm nada de especial e somente pode ser descartada em pares. Ao fazer, o jogador que descartou deve pegar uma carta aleatória da mão de qualquer jogador a sua escolha.'));
        }
