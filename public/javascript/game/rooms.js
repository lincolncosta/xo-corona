...
var GameRoom = {
    ...
    updateCardsForElement: function (cards, element) {
        ...
        $.each(cards, function (index, card) {
            var html = "<div data-selected='false' data-id='" + card.id + "' class='card noselect card-" + card.type.toLowerCase() + " image-" + card.name.toLowerCase() + "'><span class='tooltiptext'>" + card.effect + "</span></div>";
